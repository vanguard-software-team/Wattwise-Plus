...
from .serializers import UserRegistrationSerializer,UserLoginSerializer, ConsumerHourlyConsumptionSerializer, ConsumerDailyConsumptionSerializer, ConsumerWeeklyConsumptionSerializer , ConsumerMonthlyConsumptionSerializer
from rest_framework_simplejwt.tokens import RefreshToken
...
class ConsumerConsumptionHourlyInRangeView(APIView):
    ...
    def get(self, request, email, start_date, end_date, format=None):
        ...
        try:
            ...
            return Response({"detail": "Invalid date format. Please use ISO 8601 format."}, status=400)
