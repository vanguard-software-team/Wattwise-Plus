                ...
                <div
                    ...
                    <div className="lg:grid lg:grid-cols-2 pt-0">
                        <div className=" max-w-screen-md">
                            <h2 className="mb-4 lg:text-6xl text-6xl tracking-tight font-extrabold text-gray-900  lg:visible">Energy
                                consumption visualization & forecasting</h2>

                            <p className="mb-8 font-bold text-gray-700 text-3xl">
                                An intuitive tool enabling <a className="text-orange-400">consumers</a> to visualize and forecast energy consumption
                                while empowering <a className="text-orange-400">providers</a>  to monitor consumer metrics for efficient management.
                            </p>

                            <div className="flex flex-col space-y-4 sm:flex-row sm:space-y-0 sm:space-x-4 ">
                                <Link to="/login">
                                    <button type="button"
                                            className="text-black font-play font-bold bg-orange-400 hover:bg-gray-600 focus:ring-orange-400 focus:ring-2 hover:text-white focus:outline-none px-8 py-2 text-center">Plug
                                        in
                                    </button>
                                </Link>
                            </div>
