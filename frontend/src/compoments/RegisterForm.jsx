...
function RegisterForm() {
    ...
    return (
        <form className="font-play w-96 p-7 bg-gray-100 border-4 border-gray-300 rounded-lg">
            <h1 className="text-center text-2xl font-bold">Sign Up</h1>
            {
                providerIndicator ? (
                        <>
                            ...
                            <div className="mb-6">
                                <label htmlFor="power_suply_number"
                    ...
                    (
                        <>
                            ...
                            <div className="mb-6">
                                <label htmlFor="secret_provider_code"
            ...
            <label className="relative inline-flex items-center cursor-pointer">
                <input type="checkbox" onChange={switchRoleSignUp} className="sr-only peer"></input>
                <div
            ...
            <p className="p-4">You have an account? <Link to="/login" className="text-blue-500 p-2 hover:font-semibold">Log in</Link></p>
        </form>
    );
}
