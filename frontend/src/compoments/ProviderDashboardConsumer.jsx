...
const seachInputClass = "bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-orange-300 focus:border-orange-300 block w-full ps-10 p-2.5"
...
function ProviderDashboardConsumer() {
	return (
		<div className="flex justify-center items-center">
			<form className="flex lg:w-1/2 w-full items-center mt-10">
