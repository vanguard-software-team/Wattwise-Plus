...
function SimpleResultCard({title, result, difference}) {
    return (
        <div
            className="grid lg:grid-cols-2 pt-10 h-36 bg-gray-50 border-orange-400 border-b-2 rounded-lg  hover:bg-gray-100">
            <div>
