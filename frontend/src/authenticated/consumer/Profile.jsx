...
import FormBasicInformation from "../../components/FormBasicInformation.jsx";
import FormMoreInformation from "../../components/FormMoreInformation.jsx";
...
function Profile() {
	return (
		<AuthenticatedLayout>
			<div className="p-2 sm:ml-40 bg-gray-50 font-ubuntu">
